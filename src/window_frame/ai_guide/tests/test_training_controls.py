...
from window_frame.ai_guide.training.train_model import limit_samples, main, visualization_ids
...
class TrainingControlTests(unittest.TestCase):
    ...
    def test_small_subsets_keep_split_boundaries(self):
        ...
        settings = dict(seed=42, max_train_samples=50, max_validation_samples=10)
    ...
    def test_command_line_limits(self):
        with patch('sys.argv', ['train-window-frame', '--epochs', '5', '--max-train-samples', '50',
